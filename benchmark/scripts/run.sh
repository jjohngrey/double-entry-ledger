...
PROJECTION_DB_MAX_OPEN_CONNS=${PROJECTION_DB_MAX_OPEN_CONNS:-20}
...
DB_TRANSFER_POOL_CONNS=${DB_TRANSFER_POOL_CONNS:-2}
DB_PUBLISHER_POOL_CONNS=${DB_PUBLISHER_POOL_CONNS:-14}
DB_AGGREGATE_POOL_CONNS=${DB_AGGREGATE_POOL_CONNS:-4}
...
POSTING_BATCH_SIZE=${POSTING_BATCH_SIZE:-64}
...
if ! env BENCHMARK_DATABASE_URL="$BENCHMARK_DATABASE_URL" BENCHMARK_PROJECTION_DATABASE_URL="$BENCHMARK_PROJECTION_DATABASE_URL" NATS_URL="$NATS_URL" \
...
if [ "$START_SERVER" = "1" ]; then
  env DATABASE_URL="$BENCHMARK_DATABASE_URL" PROJECTION_DATABASE_URL="$BENCHMARK_PROJECTION_DATABASE_URL" NATS_URL="$NATS_URL" \
    PROJECTION_DB_MAX_OPEN_CONNS="$PROJECTION_DB_MAX_OPEN_CONNS" \
    ...
    DB_TRANSFER_POOL_CONNS="$DB_TRANSFER_POOL_CONNS" \
    DB_PUBLISHER_POOL_CONNS="$DB_PUBLISHER_POOL_CONNS" \
    DB_AGGREGATE_POOL_CONNS="$DB_AGGREGATE_POOL_CONNS" \
...
export BENCHMARK_DATABASE_URL BENCHMARK_PROJECTION_DATABASE_URL BENCHMARK_DATA_FILE TARGET_TPS WARMUP_TPS
export PROJECTION_DB_MAX_OPEN_CONNS
...
export DB_TRANSFER_POOL_CONNS DB_PUBLISHER_POOL_CONNS DB_AGGREGATE_POOL_CONNS
